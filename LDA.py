# -*- coding: utf-8 -*-
"""
Created on Thu Jun  9 20:49:48 2022
...
log_file_name = "./%s/LDA_layer_%d_group_%d_lr_%.4f.txt" % \
...
#%% initialize model
model = LDA_weighted(layer_num, start_phase, sparse_view_num, alpha, beta)
...
for i in range(sparse_view_num):
    f_mask[:,:,i*8,:] = 1
f_mask = f_mask.repeat(batch_size, 1, 1, 1)
